<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditUser.aspx.cs" Inherits="InventoryManagement.Pages.Users.EditUser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                <label>
                    <asp:Label runat="server" Text="Active"></asp:Label></label>
                <asp:CheckBox runat="server" ID="chkIsActive" CssClass="form-control" Checked="true" />
            </div>
        </div>
    </div>

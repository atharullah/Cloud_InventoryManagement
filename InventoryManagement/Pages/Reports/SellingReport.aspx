<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SellingReport.aspx.cs" Inherits="InventoryManagement.Pages.Reports.SellingReport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="row topHeader">
        <div class="text-center">Selling Report</div>
            ...
            <asp:Repeater runat="server" ID="rptrInventoryReport">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:Label runat="server" ID="Label3" Text='<%#Eval("TotalAmount")%>'></asp:Label></td>
                        <td>

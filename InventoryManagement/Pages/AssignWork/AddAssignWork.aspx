<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddAssignWork.aspx.cs" Inherits="InventoryManagement.Pages.AssignWork.AddAssignWork" %>
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    <div class="row topHeader">
        <div class="col-md-12">
            <div class="text-center">Assign New Work</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <asp:DropDownList CssClass="form-control" runat="server" ID="ddlEmployeeName"></asp:DropDownList>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <asp:DropDownList CssClass="form-control" runat="server" ID="ddlBillNo"></asp:DropDownList>

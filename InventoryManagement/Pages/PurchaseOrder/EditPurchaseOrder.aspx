<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditPurchaseOrder.aspx.cs" Inherits="InventoryManagement.Inventory.EditPurchaseOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="row topHeader">
        <div class="col-md-12">
            <div class="form-group">
                <div class="text-center">Edit Order Detail</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <asp:LinkButton CausesValidation="false" CssClass="btn btn-primary btn-block" Text="All Purchase Order" runat="server" PostBackUrl="AllPurchaseOrders.aspx"></asp:LinkButton>
        </div>
    </div>
    &nbsp;
            ...
            <asp:Repeater runat="server" ID="rptrData" OnItemCommand="rptrData_ItemCommand">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                           <asp:HiddenField runat="server" ID="rptrhdnOrderDetailID" Value='<%#Eval("OrderDetailID")%>' /> 
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                <asp:Button CssClass="btn btn-primary btn-block" runat="server" ID="btnUpdateInventory" Text="Update Inventory" OnClick="btnUpdateInventory_Click" />
            </div>
        </div>
    </div>

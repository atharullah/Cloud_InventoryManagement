<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditSaleOrder.aspx.cs" Inherits="InventoryManagement.Pages.SaleOrder.EditSaleOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="row topHeader">
        <div class="col-md-12">
            <div class="text-center">Update Sales Order</div>
    ...
    <div class="row topHeader rowMaking" style="display: none">
        <div class="col-md-12">
            ...
            <asp:HiddenField runat="server" ID="hdnDevWorkID" />
        </div>
    </div>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:HiddenField runat="server" ID="hdnSaleOrderDetailID" Value='<%#Eval("SaleOrderDetailID")%>' />
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                <asp:Button CssClass="btn btn-primary btn-block" ValidationGroup="orderDetail" runat="server" ID="btnUpdateSaleOrder" Text="Update Order" OnClick="btnUpdateSaleOrder_Click" />
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <asp:RegularExpressionValidator SetFocusOnError="true" ValidationGroup="popupCustomer" runat="server" ControlToValidate="txtPopupCustomerMobile" ErrorMessage="Not Valid Mobile" ForeColor="Red" ValidationExpression="^\d{10}$" Display="Dynamic"></asp:RegularExpressionValidator>
